-- Seed data generated from src/content/projects.json — safe to re-run (upsert on id).

insert into public.projects
  (id, section, position, title, nav_label, sub_lines, lines, links, paragraphs, videos, meta, gallery)
values (
  $t$i-hear$t$,
  $t$main$t$,
  1,
...
values (
  ...
  $j$["/images/works/concretely-01.jpg","/images/works/concretely-02.jpg","/images/works/concretely-03.jpg","/images/works/concretely-04.jpg","/images/works/concretely-05.png","/images/works/concretely-06.png","/images/works/concretely-07.jpg","/images/works/concretely-08.jpg","/images/works/concretely-09.jpg"]$j$::jsonb
)
on conflict (id) do update set
  section = excluded.section,
  position = excluded.position,
...
values (
  ...
  $j$[{"label":"Mophradat consortium-commissions","href":"https://mophradat.org/en/program/consortium-commissions/2023-2025/"}]$j$::jsonb,
  $j$["Ltaief's research performance project «Parallel Hands — Co-existence of Times and the Good Will to Listen» investigates the legacy of North African sonic archives in the collection of Berliner Phonogramm-Archiv and Ethnologisches Museum in Berlin. It specifically re-traces the early phonogram sound archives that were commissioned and classified during the 1910s and are today settled in ethnomusicological collections stored in Berlin at SMB museums.","These archives include recordings made by the German Phonographic Commission, established by Wilhelm Doegen and assisted by Robert Lachmann with prisoners of the First World War, between 1915 and 1918 at the Half Moon camp in Wünsdorf (south Berlin). Some of these prisoners were Tunisian, like Sadok Ben Rashid.","This project critically investigates notions of record and archive, raising questions about ethnological field recording practices under the violence of European Colonialism; about the limits of translation, and the enduring myth of universal art doctrines.","* The double showing is followed by a discussion with the artists *"]$j$::jsonb,
  $j$[]$j$::jsonb,
  ...
  $j$["/images/works/parallel-01.jpg","/images/works/parallel-02.jpg","/images/works/parallel-03.jpg","/images/works/parallel-04.jpg","/images/works/parallel-05.jpg","/images/works/parallel-06.jpg","/images/works/parallel-07.jpg","/images/works/parallel-08.jpg","/images/works/parallel-09.jpg"]$j$::jsonb
)
on conflict (id) do update set
  section = excluded.section,
  position = excluded.position,
...
values (
  ...
  $j$[]$j$::jsonb,
  $j$["Mohamedali conducted research during his residency in Tunis on the market of Chinese products: the Boumendil market in the Medina of Tunis. In particular, he investigates the impact of the Chinese market on Boumendi street history / the Medina of Tunis and explores with Omar Karray their particular soundscape.","Research / residency — Exile in Arabic is Eghtirab — Moghtareb which means, the person who walks towards the sunset — Ghouroub. The exile is an utopian counter-space as Michel Foucault says in the utopia of the body: “My body is like the city of the sun, it has no place, but it is from itself that emerge and shine all possible places, real ones or utopic ones”."]$j$::jsonb,
  $j$[]$j$::jsonb,
  ...
  $j$["/images/works/pathsun-01.jpg","/images/works/pathsun-02.jpg","/images/works/pathsun-03.jpg"]$j$::jsonb
)
on conflict (id) do update set
  section = excluded.section,
  position = excluded.position,
...
values (
  ...
  $j$["/images/works/hundert-01.jpg","/images/works/hundert-02.jpg","/images/works/hundert-03.jpg","/images/works/hundert-04.webp","/images/works/hundert-05.jpg","/images/works/hundert-06.jpg","/images/works/hundert-07.jpg","/images/works/hundert-08.png"]$j$::jsonb
)
on conflict (id) do update set
  section = excluded.section,
  position = excluded.position,
...
values (
  ...
  $j$[{"label":"Video documentation","href":"https://vimeo.com/355958609"}]$j$::jsonb,
  $j$["Ghosts of Meaning is a performance presented at HAU Hebbel am Ufer (HAU2) in Berlin, 2019.","The work belongs to a series of performative and sonic investigations into language, translation and the residues of meaning that persist beyond speech — the spectral remainders of words displaced across geographies, alphabets and political conditions."]$j$::jsonb,
  $j$[]$j$::jsonb,
  $t$$t$,
  $j$["/images/works/ghosts-01.jpg","/images/works/ghosts-02.jpg","/images/works/ghosts-03.jpg"]$j$::jsonb
)
on conflict (id) do update set
  section = excluded.section,
  position = excluded.position,
...
values (
  ...
  $j$["/images/works/caliban-01.jpg","/images/works/caliban-02.jpg","/images/works/caliban-03.jpg","/images/works/caliban-04.jpg","/images/works/caliban-05.jpeg","/images/works/caliban-06.jpg","/images/works/caliban-07.jpg","/images/works/caliban-08.jpg","/images/works/caliban-09.jpeg","/images/works/caliban-10.jpg","/images/works/caliban-11.png","/images/works/caliban-12.jpg","/images/works/caliban-13.jpg","/images/works/caliban-14.png","/images/works/caliban-15.jpg","/images/works/caliban-16.jpg","/images/works/caliban-17.jpg","/images/works/caliban-18.jpg","/images/works/caliban-19.jpg"]$j$::jsonb
)
on conflict (id) do update set
  section = excluded.section,
  position = excluded.position,
...
values (
  ...
  $j$[]$j$::jsonb,
  $j$["It is with these words that Motus launched the project Animale Politico 2011>2068. The company is now returning to Santarcangelo, the place where it all began, in order to look backwards and outline the cartography of these intense years of research and encounters with “extraordinary women and men”.","Call me X is an attempt to reassemble the images of the company's latest theatrical and life adventure, represented by performative actions, workshops, residencies, public conferences and urban interventions. Motus embarks on a trip following the crumb trail of documents and relics left by the heterogenous endeavor that generated Nella Tempesta and Caliban Cannibal.","What emerges is an artistic itinerary marked by temporary experiences and landscapes located inside an “elsewhere” that the company inhabits like a climbing plant, always on the edge."]$j$::jsonb,
  $j$[]$j$::jsonb,
  $t$$t$,
  $j$["/images/works/callmex-01.jpg","/images/works/callmex-02.jpg","/images/works/callmex-03.jpeg"]$j$::jsonb
)
on conflict (id) do update set
  section = excluded.section,
  position = excluded.position,
...
values (
  ...
  $j$[{"label":"Resonance Extra","href":"https://extra.resonance.fm/"},{"label":"bookworks.org.uk","href":"https://bookworks.org.uk/news/without-reduction-a-twelve-hour-radio-broadcast-by-book-works-for-the-happy-hypocrite/"}]$j$::jsonb,
  $j$["Text: Abu Hayyan al-Tawhidi, Julia Kristeva, Giorgio Agamben, Samuel Beckett. Recording and sound art: Omar Karray. Voices: Marina Resende, Santos, Ayed Fadhel, Rindala Pereverzev and Mohamedali Ltaief.","Part of Without Reduction, a twelve-hour radio broadcast by Book Works for The Happy Hypocrite."]$j$::jsonb,
  $j$[]$j$::jsonb,
  $t$$t$,
...
values (
  ...
  $j$[]$j$::jsonb,
  $j$["Lecture performance by Mohamed-Ali Ltaief in der Refo Kapelle zur Eröffnung der Ausstellung SONIC RESISTANCE.","The lecture negotiates the Arab presence in interwar Germany through the frequencies of sonic resistance and survival: the record labels, exiled musicians, dancers and anti-colonial networks that circulated between Berlin, Tunis, Cairo and Beirut in the first decades of the twentieth century."]$j$::jsonb,
  $j$[]$j$::jsonb,
  $t$$t$,
  $j$[]$j$::jsonb
)
...
values (
  ...
  $j$[{"label":"www.archivesites.org","href":"https://www.archivesites.org"}]$j$::jsonb,
  $j$["5 – 6.30 pm — Reading Circle. Workshop as part of Unpacking our Library #6. By registration: malab@archivesites.org","Based on the ongoing research-based project of an artist that confronts and expands the meaning of sonic archives, Mohamed-Ali Ltaief offers a Reading Circle to share and discuss the genealogy of early ethnomusicological field recording in Tunisia, while reassembling cartographies of interwar artists in North Africa and in the diaspora. In the Reading Circle workshop, Ltaief will share a selection of readings that he refers to in his lecture performance, re-contextualizing cuts and ruptures during colonial times, and unraveling the multiplicity of sonic performative practices. The Reading Circle is open to everyone interested in African performance art histories and sonic performative art practices, anti-colonial and anti-fascist early political movements in North Africa, decolonial theories, and practices of transformation of archives.","7 – 8 pm — Unpacking our Library #6: Poeisis, Praxis, and Cultures of Resistance or the non-established Histories of Art in Tunisia.","Unpacking Our Library invites Tunisian artist and author Mohamed-Ali Ltaief to re-entangle and negotiate the meaning of a North African sonic archive collection recorded during the first decade of the 20th Century by the Prussian Phonographic Commissions in North Africa, and now stored and dispersed, in part at the Berliner Phonogramm Archiv (SMB) at the Ethnologisches Museum in Berlin and in part at the Ennejma Ezzahra in Tunis.","Ltaief's lecture performance questions the dispositive of sonic archival material in those collections by displacing the Ethno-musicological illusion. Through the lecture, Ltaief revoices extended biographies and foregrounds sonic performances, confronting the static sonic archival materiality and the corporate identity of the Western aesthetic taxonomy. By shifting the sonic archive into a spatialized and performative practice, Ltaief opens those archives to art histories across Berlin, Beirut, Cairo, and Tunis. Acknowledging the intrinsic multiplicity of art as a concept of “Poiesis and Praxis”, the lecture is composed of acts of translating lyrics, retracing movements-body language, and re-locating biographies and counter archives.","This lecture performance is a sonic-visual and geo-philosophical narrative that combines sonic testimonies with spatial strategies, border studies, and decolonial aesthetic methods. It is part of ‘the Striated Time’ performance trilogy project and publication."]$j$::jsonb,
  $j$[]$j$::jsonb,
...
values (
  ...
  $j$[{"label":"S.a.L.E. Docks","href":"http://www.saledocks.org/"}]$j$::jsonb,
  $j$["Lecture performance at S.a.L.E. Docks, Venice, 2012.","Delivered in the aftermath of the Tunisian revolution and within the occupied spaces of Venice, the lecture addressed the practice of the common: self-organisation, occupation as a cultural form, and the shared infrastructures that artists and activists build outside institutional frameworks."]$j$::jsonb,
  $j$[]$j$::jsonb,
  $t$$t$,
...
values (
  ...
  $j$[]$j$::jsonb,
  $j$["Chronicles of the Half-Moon gathers the writing that accompanies the performance and research cycle around the Half Moon camp (Halbmondlager) at Wünsdorf, south of Berlin, where the Royal Prussian Phonographic Commission recorded the voices of colonial prisoners of war between 1915 and 1918.","The chronicles assemble archival fragments, translated lyrics, personal files (Personalbogen), biographies and counter-narratives — among them the voice of Sadok Ben Rachid Haj Youssef, a farm worker, poet and singer from Monastir who sang before a gramophone horn in May 1916.","The writing moves between document and fiction, refusing the ethnographic frame in which these voices were captured and returning them to the register of poetry, lament and refusal."]$j$::jsonb,
  $j$[]$j$::jsonb,
...
values (
  ...
  $j$[{"label":"bookworks.org.uk","href":"https://bookworks.org.uk/news/without-reduction-a-twelve-hour-radio-broadcast-by-book-works-for-the-happy-hypocrite/"}]$j$::jsonb,
  $j$["A text and sound work assembled from Abu Hayyan al-Tawhidi, Julia Kristeva, Giorgio Agamben and Samuel Beckett, written for Book Works and The Happy Hypocrite.","The writing circles the figure of the stranger — the one whose strangeness is not a property but a relation — and the estrangement produced by borders, translation and exile."]$j$::jsonb,
  $j$[]$j$::jsonb,
  $t$$t$,
  $j$["/images/works/strangeness-01.jpg","/images/works/strangeness-02.jpg","/images/works/strangeness-03.jpg","/images/works/strangeness-04.jpg","/images/works/strangeness-05.jpg","/images/works/strangeness-06.jpg","/images/works/strangeness-07.jpg","/images/works/strangeness-08.jpg"]$j$::jsonb
)
...
values (
  ...
  $j$[]$j$::jsonb,
  $j$["Awham (أوهام) — illusions. An ongoing writing and publishing practice in Arabic and in translation, moving between poetry, note-taking, and the essay.","The texts accompany the sonic and performance research, holding what cannot be staged: the residue of listening, the aside, the fragment."]$j$::jsonb,
  $j$[]$j$::jsonb,
  $t$$t$,
...
values (
  ...
  $j$[{"label":"Damiani editore","href":"https://www.damianibooks.com/en/products/6208518"}]$j$::jsonb,
  $j$["Hello Stranger — publication with Motus, published by Damiani editore, Bologna, 2017.","The book gathers the images, documents and writings produced across the years of the 2011 > 2068 AnimalePolitico Project, and the encounters, journeys and shelters that Caliban Cannibal and Nella Tempesta left behind."]$j$::jsonb,
  $j$[]$j$::jsonb,
  $t$$t$,
  $j$[]$j$::jsonb
)
...
values (
  ...
  $j$[]$j$::jsonb,
  $j$["Cinema of Leak — a happening organised with the Ahl Al-Kahf (People of the Cave) collective in Djerba, Tunisia, 2012.","Ahl Al-Kahf was an anonymous street art and agitation collective active in Tunisia during and after the revolution, working with walls, screenings and public interventions as forms of political address."]$j$::jsonb,
  $j$[]$j$::jsonb,
  $t$$t$,
...
values (
  ...
  $j$[{"label":"Exorma edizioni","href":"https://www.exormaedizioni.com/catalogo/i-muri-di-tunisi/"}]$j$::jsonb,
  $j$["I muri di Tunisi — The walls of Tunis, Signs of Revolt. Publication with Luce Lacquaniti, Exorma edizioni, Rome, 2015.","The book reads the revolution through its walls: the graffiti, slogans, erasures and repaintings that turned the surfaces of Tunis into a contested archive of the uprising and its aftermath."]$j$::jsonb,
  $j$[]$j$::jsonb,
  $t$$t$,
